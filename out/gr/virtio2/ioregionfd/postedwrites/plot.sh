    ...
    for v in 'vhostoff' 'vhoston'; do
        ...
        if [ ! -f "${load_latency_output}" ]; then
            ...
            ../../../../../plot_load_latency.py \
                ...
                --darkgreen "../../../../../dat/gr/virtio2/acc_histogram_${darkgreeninfix1}_"*"_${darkgreeninfix2}_"* \
                --darkgreen-name "${darkgreenlabel}" \
                --limegreen "../../../../../dat/gr/virtio2/acc_histogram_${limegreeninfix1}_"*"_${limegreeninfix2}_"* \
        ...
        if [ ! -f "${packet_loss_output}" ]; then
            ...
            ../../../../../plot_packet_loss.py \
                ...
                --orange-name "${orangelabel}" \
                --darkgreen "../../../../../dat/gr/virtio2/output_${darkgreeninfix1}_"*"_${darkgreeninfix2}_"* \
                --darkgreen-name "${darkgreenlabel}" \
                --limegreen "../../../../../dat/gr/virtio2/output_${limegreeninfix1}_"*"_${limegreeninfix2}_"* \
                --limegreen-name "${limegreenlabel}" \
                --width 9 \
                --height 2 \
