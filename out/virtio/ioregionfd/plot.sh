...
../../../plot_load_latency.py \
    ...
    --red ../../../dat/virtio/acc_histogram_microvm_bridge_normal_vhostoff_ioregionfdon_xdp_* \
...
../../../plot_load_latency.py \
    --blue ../../../dat/virtio/acc_histogram_microvm_macvtap_normal_vhoston_ioregionfdoff_xdp_* \
    --blue-name "ioregionfdoff" \
...
../../../plot_packet_loss.py \
    ...
    --blue-name "ioregionfdoff" \
    --red ../../../dat/virtio/output_microvm_bridge_normal_vhostoff_ioregionfdon_xdp_* \
    --red-name "ioregionfdon" \
    --width 6 --height 6 \
...
../../../plot_packet_loss.py \
    --blue ../../../dat/virtio/output_microvm_macvtap_normal_vhoston_ioregionfdoff_xdp_* \
    --blue-name "ioregionfdoff" \
