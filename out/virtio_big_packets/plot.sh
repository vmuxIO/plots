        ...
        for v in 'vhostoff' 'vhoston'; do
            for i in 'ioregionfdoff' 'ioregionfdon'; do
                ...
                for r in "moongen" "xdp"; do
                    ...
                    infix="${name// /_}"
                    echo "Plotting ${name}"
                    ../../plot_load_latency.py --red "../../dat/virtio_big_packets/acc_histogram_${infix}_"* --red-name "" --logarithmic --width 6 --height 6 --output "load_latency_${infix}.pdf"
                    ../../plot_packet_loss.py --red "../../dat/virtio_big_packets/output_${infix}_"* --red-name "" --width 6 --height 6 --output "packet_loss_${infix}.pdf"
                done
            done
        done
    done
