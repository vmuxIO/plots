...
../../../plot_load_latency.py \
    ...
    --blue-name "vhostoff" \
    --red ../../../dat/virtio_big_packets/acc_histogram_pcvm_bridge_normal_vhoston_ioregionfdoff_moongen_* \
    --red-name "vhoston" \
    --width 6 --height 6 \
    --logarithmic \
...
../../../plot_load_latency.py \
    ...
    --blue-name "vhostoff" \
    --red ../../../dat/virtio_big_packets/acc_histogram_pcvm_macvtap_normal_vhoston_ioregionfdoff_moongen_* \
    --red-name "vhoston" \
    --width 6 --height 6 \
    --logarithmic \
...
../../../plot_load_latency.py \
    --blue ../../../dat/virtio_big_packets/acc_histogram_microvm_macvtap_normal_vhostoff_ioregionfdon_xdp_* \
    --blue-name "vhostoff" \
...
../../../plot_packet_loss.py \
    ...
    --blue-name "vhostoff" \
    --red ../../../dat/virtio_big_packets/output_pcvm_bridge_normal_vhoston_ioregionfdoff_moongen_* \
    --red-name "vhoston" \
    --width 6 --height 6 \
...
../../../plot_packet_loss.py \
    ...
    --blue-name "vhostoff" \
    --red ../../../dat/virtio_big_packets/output_pcvm_macvtap_normal_vhoston_ioregionfdoff_moongen_* \
    --red-name "vhoston" \
    --width 6 --height 6 \
...
../../../plot_packet_loss.py \
    --blue ../../../dat/virtio_big_packets/output_microvm_macvtap_normal_vhostoff_ioregionfdon_xdp_* \
    --blue-name "vhostoff" \
